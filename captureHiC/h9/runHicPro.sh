...
#Path to raw files
RAW="/shared/projects/primate_hic/captureHiC/h9/raw"
#Folder path for outputs
OUTPATH="/shared/projects/primate_hic/captureHiC/h9/hicpro_results"
#Path to config file
CONFIG="/shared/projects/primate_hic/captureHiC/h9/config-hicpro.txt"
