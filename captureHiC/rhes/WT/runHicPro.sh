...
#Path to raw files
RAW="/shared/projects/primate_hic/captureHiC/rhes/WT/raw"
#Folder path for outputs
OUTPATH="/shared/projects/primate_hic/captureHiC/rhes/WT/hicpro_results"
#Path to config file
CONFIG="/shared/projects/primate_hic/captureHiC/rhes/WT/config-hicpro.txt"
